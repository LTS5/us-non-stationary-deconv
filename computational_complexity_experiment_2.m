...
%-- Output filenames
filename_out = 'results/comp_times_exp2.mat';

%-- PSF method
list_flag_psf_meth = [2, 3];
...
n_elements = 128;
nt = 500;
list_n_z = [500, 1000, 2000, 4000, 8000];
list_n_x = 4*n_elements;
list_grid_sizes = list_n_z.*list_n_x;
...
ratio_comp_times = t_avg_proposed./t_avg_shiftinvariant;
